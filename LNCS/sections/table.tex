...
\begin{table*}[ht!]
    ...
    \caption{An evaluation of upgradeability patterns. \full~ indicates the upgrade method is awarded the benefit in the corresponding column. \prt~partially awards the benefit.} 
    \label{tab:eval}
    \end{table*}
