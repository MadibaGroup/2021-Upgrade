...
\textblue{selfdestruct happens at end of transaction -> race condition}
...
Table~\ref{tab:eval} summarizes the pros and cons of each upgradability pattern. We omit concensus override because unrealistc.  The details of the evaluation are provided in the full version of this paper.\footnote{To be archived. Can be provided anonymously though program chairs.}
