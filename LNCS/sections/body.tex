...
All the remained proxy contracts are marked as non-upgradeable proxy contracts. The whole process is depicted on figure~\ref{flowchart}. For the detailed explanation of the methodology applied check the appendix.
